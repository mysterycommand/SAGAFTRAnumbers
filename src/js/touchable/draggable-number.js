  ...
  define(['jquery', 'touchable/touchable'], function($, Touchable) {
    ...
    DraggableNumber = (function() {
      ...
      function DraggableNumber(element, options) {
        ...
        this.onTouchableUp = __bind(this.onTouchableUp, this);

        this.onTouchableMove = __bind(this.onTouchableMove, this);

        this.onTouchableDown = __bind(this.onTouchableDown, this);
      ...
      DraggableNumber.prototype.onTouchableDown = function(event, touches) {
        ...
        this.min = (_ref = (_ref1 = this.$ele.attr('min')) != null ? _ref1 : typeof options !== "undefined" && options !== null ? options.min : void 0) != null ? _ref : 0;
        this.max = (_ref2 = (_ref3 = this.$ele.attr('max')) != null ? _ref3 : typeof options !== "undefined" && options !== null ? options.max : void 0) != null ? _ref2 : 1e100;
        this.step = (_ref4 = (_ref5 = this.$ele.attr('step')) != null ? _ref5 : typeof options !== "undefined" && options !== null ? options.step : void 0) != null ? _ref4 : 1;
