    ...
    Use = (function() {
      ...
      Use.prototype.onUseChange = function(event) {
        ...
        if (this.selectedItem != null) {
          this.$el.append(this.selectedItem.$el);
          if (this.selectedIndex === 0 || this.selectedIndex === 2) {
            return this.$el.off('change', '#broadcast-type').on('change', '#broadcast-type', this.onBroadcastChange);
          }
        }
      };
      ...
      Use.prototype.onBroadcastChange = function(event) {
        ...
        return this.$el.after(broadcastType.$el);
      };
