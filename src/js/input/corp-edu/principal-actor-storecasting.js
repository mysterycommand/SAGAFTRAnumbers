...
(function() {
  ...
  define(['jquery', 'underscore', 'input/corp-edu/principal-actor-hour'], function($, _, PrincipalActorHour) {
    var PrincipalActorStorecasting;
    PrincipalActorStorecasting = (function() {

      function PrincipalActorStorecasting() {
      ...
      PrincipalActorStorecasting.prototype.onInputPrincipals = function(event) {
      ...
      return PrincipalActorStorecasting;
