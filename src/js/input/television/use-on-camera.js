...
(function() {
  ...
  define(['jquery', 'underscore', 'input/television/use-broadcast-on-camera', 'input/television/use-internet', 'input/television/use-both-on-camera'], function($, _, UseBroadcast, UseInternet, UseBoth) {
    var Use,
      _this = this;
    Use = (function() {
