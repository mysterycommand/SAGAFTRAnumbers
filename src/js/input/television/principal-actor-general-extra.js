    ...
    PrincipalActorGeneralExtra = (function() {
      ...
      function PrincipalActorGeneralExtra(index) {
        ...
        this.onInputExtras = function(event) {
          return PrincipalActorGeneralExtra.prototype.onInputExtras.apply(_this, arguments);
        };
        this.onInputActors = function(event) {
          return PrincipalActorGeneralExtra.prototype.onInputActors.apply(_this, arguments);
        };
