(function() {
  ...
  define(['jquery', 'underscore', 'input/television/use-broadcast', 'input/television/use-internet', 'input/television/use-both'], function($, _, UseBroadcast, UseInternet, UseBoth) {
    var Use;
    Use = (function() {
