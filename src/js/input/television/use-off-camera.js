...
(function() {
  ...
  define(['jquery', 'underscore', 'input/television/use-broadcast-off-camera', 'input/television/use-internet', 'input/television/use-both-off-camera'], function($, _, UseBroadcast, UseInternet, UseBoth) {
    var Use,
      _this = this;
    Use = (function() {
      ...
      function Use() {
        var _this = this;
        this.onBroadcastChange = function(event) {
          return Use.prototype.onBroadcastChange.apply(_this, arguments);
        };
        this.onUseChange = function(event) {
          return Use.prototype.onUseChange.apply(_this, arguments);
        };
      ...
      Use.prototype.onUseChange = function(event) {
        ...
        this.$el.nextAll().not('#input-cta').detach();
