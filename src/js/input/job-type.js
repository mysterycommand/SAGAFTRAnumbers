  ...
  define(['jquery', 'underscore', 'input/radio/*', 'input/television/*', 'input/psa/*', 'input/corp-edu/*', 'chosen'], function($, _, Radio, TV, PSA, CorpEdu) {
    ...
    JobType = (function() {
      ...
      JobType.prototype.onChange = function(event) {
        var headsUp, isPSA, mailto, _ref, _ref1;
        ...
        if (this.selectedItem != null) {
          ...
          this.$el.after(this.selectedItem.$el);
          ...
          if ((2 <= (_ref1 = this.selectedIndex) && _ref1 <= 4)) {
            this.selectedItem.$el.find('#num-days').trigger('input');
          }
